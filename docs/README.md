...
This index tracks all project documentation artifacts.

## Phase documents
- Phase 1 Project Charter: [phase-1/project-charter.md](phase-1/project-charter.md)
- Phase 1 KPI Dictionary: [phase-1/kpi-dictionary.md](phase-1/kpi-dictionary.md)
- Phase 1 Acceptance Checklist: [phase-1/acceptance-checklist.md](phase-1/acceptance-checklist.md)
...
- Keep wording understandable to both technical and non-technical stakeholders.
